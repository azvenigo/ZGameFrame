...
public:
    ...
    bool    Rasterize(ZBuffer* pDestination, ZBuffer* pTexture, tColorVertexArray& vertexArray, ZRect* pClip = NULL);
...
private:
    ...
    void    SetupRasterization(ZBuffer* pDestination, ZBuffer* pTexture, tUVVertexArray& vertexArray, ZRect& rDest, ZRect* pClip, double& fClipLeft, double& fClipRight, int64_t& nTopScanline, int64_t& nBottomScanline);
    ...
    void    SetupRasterization(ZBuffer* pDestination, ZBuffer* pTexture, tColorVertexArray& vertexArray, ZRect& rDest, ZRect* pClip, double& fClipLeft, double& fClipRight, int64_t& nTopScanline, int64_t& nBottomScanline);

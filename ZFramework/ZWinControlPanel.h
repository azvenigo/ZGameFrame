...
public:
    ...
    bool            AddToggle(bool* pbValue, const std::string& sCaption, const std::string& sCheckMessage, const std::string& sUncheckMessage, tZFontPtr pFont, uint32_t nCheckedFontCol = 0xff000000, uint32_t nUncheckedFontCol = 0xff000000, ZFont::eStyle style = ZFont::kNormal);
